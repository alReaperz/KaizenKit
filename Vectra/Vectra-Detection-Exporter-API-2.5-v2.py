...
def run_query():
    ...
    try:
        ...
        url = f"https://{vectra_server}/api/v2.5/search/detections/?page_size=5000&query_string=detection.created_timestamp%3A%5B{start_time_utc}%20TO%20{end_time_utc}%5D"
...
def open_url(event=None):
    url = "https://github.com/alReaperz/KaizenKit/blob/main/Vectra/Vectra-Detection-Exporter-API-2.5-v2.py"
    webbrowser.open(url)
